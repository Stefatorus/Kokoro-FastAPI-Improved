...
async def generate_from_phonemes(
    ...
    try:
        ...
        writer = StreamingAudioWriter(format="wav", sample_rate=AudioService.get_output_sample_rate(), channels=1)
        normalizer = AudioNormalizer(sample_rate=AudioService.get_output_sample_rate())
